    ...
    <div className='container mx-auto px-4 my-6 relative'>
           ...
           {   loading ? (
                        ...
                        <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-32 bg-white rounded-sm shadow flex'>
                            ...
                            <div className='p-4 grid w-full gap-2'>
                                ...
                                <div className='flex gap-3 w-full'>
                                    <p className='text-teal-600 font-medium p-1 bg-slate-200 w-full animate-pulse rounded-full'></p>
            ...
            data.map((product,index)=>{
                return(
                    <Link to={"product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-32 bg-white rounded-sm shadow flex'>
                        ...
                        <div className='p-4 grid'>
                            ...
                            <div className='flex gap-3'>
                                <p className='text-teal-600 font-medium'>{ displayCedisCurrency(product?.sellingPrice) }</p>
                                <p className='text-slate-500 line-through'>{ displayCedisCurrency(product?.price)  }</p>
                            </div>
